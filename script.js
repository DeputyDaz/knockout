...
const bracketColumns = [
  {
    ...
    subtitle: "Left half",
    matches: [
      match(74, "Round of 32", "29 Jun, 12:00 AM UK", "Los Angeles", { flag: "DE", name: "Germany", owner: placeholderOwner, score: "1 (2)" }, { flag: "PY", name: "Paraguay", owner: placeholderOwner, score: "1 (4)"}),
  ...
  },
  {
    ...
    subtitle: "Champion",
    matches: [
      match(104, "Final", "19 Jul, 8:00 PM UK", "New York/New Jersey", { flag: "", name: "Winner Match 101", owner: placeholderOwner, score: "", winner: true }, { flag: "", name: "Winner Match 102", owner: placeholderOwner, score: "" }, true)
    ],
