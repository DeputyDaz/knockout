...
const bracketColumns = [
  {
    ...
    subtitle: "Left half",
    matches: [
      match(74, "Round of 32", "29 Jun, 12:00 AM UK", "Los Angeles", { flag: "DEU", name: "Germany", owner: placeholderOwner, score: "1 (2)" }, { flag: "PRY", name: "Paraguay", owner: placeholderOwner, score: "1 (4)",  winner: true }),
