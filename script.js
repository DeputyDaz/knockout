...
const bracketColumns = [
  {
    ...
    subtitle: "Left half",
    matches: [
      match(74, "Round of 32", "29 Jun, 12:00 AM UK", "Los Angeles", { flag: "DE", name: "Germany", owner: placeholderOwner, score: "1 (2)" }, { flag: "PY", name: "Paraguay", owner: placeholderOwner, score: "1 (4)",  winner: true }),
