...
const bracketColumns = [
  {
    ...
    subtitle: "Left half",
    matches: [
      match(74, "Round of 32", "29 Jun, 12:00 AM UK", "Los Angeles", { flag: "", name: "Winner Group E", owner: placeholderOwner, score: "" }, { flag: "", name: "3rd Group A/B/C/D/F", owner: placeholderOwner, score: ""}),
  ...
  },
  {
    ...
    subtitle: "Champion",
    matches: [
      match(104, "Final", "19 Jul, 8:00 PM UK", "New York/New Jersey", { flag: "https://flagcdn.com/w40/gb-nir.png", name: "Winner Match 101", owner: placeholderOwner, score: "", winner: true }, { flag: "", name: "Winner Match 102", owner: placeholderOwner, score: "" }, true)
    ],
