...
const bracketColumns = [
  {
    ...
    subtitle: "Left half",
    matches: [
      match(74, "Round of 32", "29 Jun, 12:00 AM UK", "Los Angeles", { flag: "ENG", name: "ENGWinner Group E", owner: DEPDaz, score: "3" }, { flag: "CRO", name: "CRO3rd Group A/B/C/D/F", owner: NOTDAZ, score: "2" }),
